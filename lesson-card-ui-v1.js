(()=>{
  ...
  const noteText=()=>state.language==='ce'?{
    button:'Блокнот',help:'ЛадоьгӀучу хенахь ладаме ойланаш а, билгалдахарш а кхузахь дӀаяздаде. ТӀетаӀае «Ӏалашдан», хӀокху гӀирса тӀехь уьш диса кхин дӀа а.',placeholder:'Билгалдахар кхузахь дӀаязде...',save:'Ӏалашдан',remove:'ДӀадаккха',saved:'Ӏалашдина',removed:'ДӀадаьккхина',copy:'Копировать всё',copied:'Скопировано',empty:'Блокнот пуст'
  }:{
